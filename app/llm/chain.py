...
class ReviewChain:
    ...
    def generate_review(self, code_diff: str) -> list[str]:
        ...
        raise ValueError("Unexpected LLM response format: expected str or object with 'content'.")